...
public class Searcher
{
    ...
    public static void main(String args[]) {
        ...
        QueryParser contentQueryParser = new QueryParser(Constants.content, analyzer);
        TermQuery tq1 = new TermQuery(new Term(Constants.content, queryMammal.toLowerCase()));
        {
            // --------------------------------------
        ...
        TermQuery tq2;
        {
            ...
            printResultsForQuery(indexSearcher, contentQueryParser.parse(queryBird));
            // --------------------------------------
        }
        ...
        try {
            ...
            for (ScoreDoc score : scoreDoc){
                ...
                System.out.println(document.get(Constants.filename)
                        + " [" + score.score + "]"
                        + " [ID: " + score.doc + "] [SIZE: " + document.get(Constants.filesize) + "]");
            }
